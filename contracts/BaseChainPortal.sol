...
contract BaseChainPortal is Governable, Guardable, ChainPortal {
    ...
    // @inheritdoc IChainPortal
    function setChainPortals(uint64[] calldata destChainSelectors, address[] calldata portals) external override onlyGovernor {
     ...
     */
    function _verifyActionRestrictions(address, address[] memory targets, uint64)
        internal
        view
        override
    {
